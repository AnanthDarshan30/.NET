...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <main>
        ...
        <!-- Label to display results (names from the database) -->
        <asp:Label ID="lblResult" runat="server" Text="Results will appear here..."></asp:Label>
        
        <!-- OR -->
        <!-- GridView to display tabular data from the database -->
